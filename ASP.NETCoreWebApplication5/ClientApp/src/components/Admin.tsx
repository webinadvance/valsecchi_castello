...
const Admin = React.memo(function () {
    ...
    const [selectedMenuItem, setSelectedMenuItem] = useState<"translations" | "routing" | "gallery">(() => {
        const savedValue = localStorage.getItem("selectedMenuItem");
        return (savedValue as "translations" | "routing" | "gallery") || "translations";
    });
    ...
    const handleMenuItemClick = (menuItem: "translations" | "routing" | "gallery") => {
            ...
            <Drawer anchor="right" open={isDrawerOpen} onClose={handleDrawerClose}>
                <List className={classes.list}>
                    <ListItem
                        ...
                        onClick={() => {
                            handleMenuItemClick("translations");
                        }}
                    >
                    ...
                    <ListItem
                        button
                        selected={selectedMenuItem === "gallery"}
                        onClick={() => {
                            handleMenuItemClick("gallery");
                        }}
                    >
